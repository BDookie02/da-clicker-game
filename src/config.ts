...
export const OPPONENTS: OpponentDef[] = [
  ...
  // -- act 2: the city gets weirder (internet legends) -------------------------
  { id: 'beachbum',  name: 'Beach Bum Barry', blurb: 'Sunburnt, chained up, and permanently on vacation.',                  tapsRequired: 7.2e7,   carColor: 0xd88a4a, carAccent: 0x9a5a24, carStyle: 'lowrider', mentalityReward: 205, spriteSlot: 'char_sunsal' },
  { id: 'ribbit',    name: 'Sir Ribbit',      blurb: 'Smug little amphibian. Feels good, apparently.',                      tapsRequired: 8.3e7,   carColor: 0x5a9e3a, carAccent: 0x3a6e22, carStyle: 'compact',  mentalityReward: 210, spriteSlot: 'char_frog' },
  { id: 'coper',     name: 'The Coper',        blurb: 'It is over. It has always been over. He waits anyway.',               tapsRequired: 9.2e7,   carColor: 0x5a6a8a, carAccent: 0x3a4a66, carStyle: 'sedan',    mentalityReward: 215, spriteSlot: 'char_coper' },
  { id: 'woodo',     name: 'Woodo Tuk-Tuk',    blurb: 'A living plank of wood. Tung. Tung. Tung.',                           tapsRequired: 1.02e8,  carColor: 0x8a5a2e, carAccent: 0x5a3a1c, carStyle: 'pickup',   mentalityReward: 220, spriteSlot: 'char_woodo' },
...
export const COSMETICS: CosmeticDef[] = [
  ...
  { id: 'orn_monk',     name: 'Goldingus',               desc: 'speaks for itself', cost: 225, slot: 'ornament', value: '#e8c84a' },
