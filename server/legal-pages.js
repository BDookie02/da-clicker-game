...
<section><h2>Retention</h2><p>Primary DISCIPLINE. account data remains while the account exists. Account deletion removes the username, Terms/profile state, cloud save, leaderboard score, referral code and claims involving the account, reports involving the account, private hide relationships, sessions, rewarded-ad ledger, and DISCIPLINE. purchase ledger from the primary account database.</p>
...
<section id="deletion"><h2>Your choices and deletion</h2><p>You can revisit advertising privacy choices from Settings. A signed-in player can choose <b>Settings &gt; Delete account</b>. You may also use the <a href="/account-deletion">web account-deletion page</a> if the app is no longer installed. Account deletion also removes that account's referral code and referral claims from the primary database. It cannot remotely erase a local save that remains on another installed device; clear the app's local storage or remove the app on that device to remove its local copy. Platform transaction, install-referral, or advertising records controlled by Google or Apple are not deleted by deleting a DISCIPLINE. account.</p></section>
...
<section><h2 class="danger">Permanent deletion</h2><p>Deletion erases the account username, Terms/profile state, cloud progress, leaderboard score, referral code and claims involving the account, reports involving the account, private hide relationships, inventory, sessions, rewarded-ad ledger, and DISCIPLINE. purchase ledger from the primary account database. It cannot remotely erase a local save that remains on another installed device; clear that device's app storage or remove the app to remove its local copy. Google Play or Apple may retain their own transaction or install-referral records.</p>
